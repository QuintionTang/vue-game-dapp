<template>
    <div class="app" id="app">
        ...
        <div class="github-container">
            <a
                href="https://github.com/QuintionTang/vue-game-dapp"
                rel="noopener"
                target="_blank"
                aria-label="Star QuintionTang/vue-game-dapp on GitHub"
                ><svg
                    viewBox="0 0 16 16"
                    width="14"
                    height="14"
...
export default {
    ...
    data() {
        return {
            ...
            github_link: "https://github.com/QuintionTang/vue-game-dapp",
        };
    },
    methods: {
        async connect() {
